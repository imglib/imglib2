...
public interface FeatureSet<T, V> {
    ...
    /**
     * Retrieve iterator over active features (which were directly added, not indirectly via dependencies). Features are
     * calculated before hands so if you call .get() on a feature twice without any update, this should be cached.
     *
