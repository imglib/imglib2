...
public class RandomAccessibleIntervalProvider<T extends NativeType<T>> extends
        AbstractFeature<RandomAccessibleInterval<T>> {

    @RequiredFeature
    IterableIntervalProvider<T> iiUpdater = new IterableIntervalProvider<T>();
     ...
     */
    @Override
    public RandomAccessibleIntervalProvider<T> copy() {
        return new RandomAccessibleIntervalProvider<T>();
    }
