 ...
 */
public class IntegralImage2< R extends NumericType< R >, T extends NumericType< T > > implements OutputAlgorithm< T >
{
	...
	public IntegralImage2( final Image< R > img, final T type, final Converter< R, T > converter )
	{
		this.img = img;
		this.type = type;
