...
public class PhaseCorrelation<T extends RealType<T>, S extends RealType<S>> implements MultiThreaded, Algorithm, Benchmark
{
	...
	{
		return testCrossCorrelation( shift, image1, image2, Util.getArrayFromValue( 5, image1.numDimensions()) );
	}
	...
	{
		return testCrossCorrelation( shift, image1, image2, Util.getArrayFromValue( minOverlapPx, image1.numDimensions()) );
	}
	                                                                        ...
	                                                                        final FourierTransform<?,?> fft1, final FourierTransform<?,?> fft2 )
	{
		...
		final ImgCursor<FloatType> cursor = invPCM.createLocalizingRasterIterator();		
	...
	{
		final ImgCursor<ComplexFloatType> cursor1 = fftImage1.createRasterIterator();
		final ImgCursor<ComplexFloatType> cursor2 = fftImage2.createRasterIterator();
	...
	{
		final ImgCursor<ComplexFloatType> cursor = fftImage.createRasterIterator();
