...
public class FFTConvolution<T extends RealType<T>, K extends RealType<K>, R extends RealType<R>>
	...
	public void run() {
		...
		final Interval imgConvolutionInterval = FFTMethods
				.paddingIntervalCentered(imgInterval,
		...
		final Interval kernelConvolutionInterval = FFTMethods
				.paddingIntervalCentered(kernelInterval,
						FinalDimensions.wrap(paddedDimensions));
		...
		final RandomAccessibleInterval<K> kernelInput = Views.interval(Views
				.extendPeriodic(Views.interval(kernel,
						kernelConvolutionInterval)),
				new FinalInterval(min, max));
		final RandomAccessibleInterval<T> imgInput = Views.interval(img,
