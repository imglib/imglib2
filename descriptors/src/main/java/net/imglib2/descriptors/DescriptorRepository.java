...
import net.imglib2.descriptors.firstorder.impl.SumRealIterable;
import net.imglib2.descriptors.geometric.area.AreaIterableInterval;
import net.imglib2.descriptors.geometric.area.AreaPolygon;
import net.imglib2.descriptors.geometric.centerofgravity.CoGIterableInterval;
import net.imglib2.descriptors.geometric.centerofgravity.CoGPolygon;
import net.imglib2.descriptors.geometric.eccentricity.EccentricityIterableInterval;
import net.imglib2.descriptors.geometric.eccentricity.EccentricityPolygon;
import net.imglib2.descriptors.geometric.perimeter.PerimeterPolygon;

/**
 * The central {@link DescriptorRepository} keeps all available implementations
 * of {@link NotAutoInstantiableFeature} {@link NumericFeature}s.
 * 
