...
import net.imglib2.descriptors.haralick.helpers.CoocMeanX;
import net.imglib2.descriptors.haralick.helpers.CoocMeanY;
import net.imglib2.descriptors.haralick.helpers.CoocParameter;
import net.imglib2.descriptors.haralick.helpers.CoocStdX;
import net.imglib2.descriptors.haralick.helpers.CoocStdY;
