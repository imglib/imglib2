...
import imglib.ops.example.function.BinaryFunction;
import imglib.ops.example.function.ConstantFunction;
import imglib.ops.example.function.ConvolutionFunction;
import imglib.ops.example.function.ImageFunction;
import imglib.ops.example.function.UnaryFunction;
import imglib.ops.example.operator.BinaryOperator;
import imglib.ops.example.operator.UnaryOperator;
import imglib.ops.example.operator.binary.AddOperator;
import imglib.ops.example.operator.binary.MultiplyOperator;
import imglib.ops.example.operator.unary.HalfOperator;
