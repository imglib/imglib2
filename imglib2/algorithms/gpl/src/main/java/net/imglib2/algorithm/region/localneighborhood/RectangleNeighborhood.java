 ...
 */
public class RectangleNeighborhood<T> implements Positionable, IterableInterval<T> {
	...
	/**
	 * Set the span of this rectangle.
	 * <p>
	 * The rectangle span is such that the size of the rectangle in dimension 
	 * <code>d</code> will be <code>2 x span[d] + 1</code>.
	 * @param span  this array content will be copied to the rectangle internal field.
	 */
	 ...
	 */
	@Override
	public RectangleNeighborhoodCursor<T> localizingCursor() {
		return cursor();
	}
