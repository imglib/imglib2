...
public class DiscNeighborhood<T> extends AbstractNeighborhood<T, ImgPlus<T>> {
	...
	public DiscNeighborhood(final ImgPlus<T> source, final double radius, final OutOfBoundsFactory<T, ImgPlus<T>> outOfBounds) {
	...
	public DiscNeighborhood(final ImgPlus<T> source, final double radius) {
		this(source, radius, new OutOfBoundsMirrorFactory<T, ImgPlus<T>>(Boundary.DOUBLE));
	}
	...
	public AbstractNeighborhood<T, ImgPlus<T>> copy() {
		return new DiscNeighborhood<T>(source, radius, outOfBounds);
	}
}
