...
/**
 * Compute an inverse FFT transform, either complex-to-real or complex-to-complex. It can be computed for individual dimensions or for consecutively for all.
 * 
