...
public class ExampleMisc {
	...
	static void basicAssignmentSequence() {
		...
		RealSqr<UnsignedByteType>  op = new RealSqr<UnsignedByteType>();
		
		Function<long[],UnsignedByteType> imageFunc =
			new RealImageFunction<UnsignedByteType>(inputImg);
		...
		ImageAssignment<UnsignedByteType> assigner = 
				new ImageAssignment<UnsignedByteType>(outputImg, origin, span, func);
