...
public class LabelingSubsetOperationsTest {
	...
	public void testUnaryOperationIteration() {
		...
		SubsetOperations.iterate(new DummyOp<String>(),
				new int[] { 0, 1 }, inLabeling, outLabeling, null);
	}

	private class DummyOp<L extends Comparable<L>> implements
		...
		public Labeling<L> compute(Labeling<L> input, Labeling<L> output) {
			...
			IterableInterval<LabelingType<L>> iterable2 = Views
					.iterable(output);
