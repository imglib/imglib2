...
//		testBounds();
	...
	public static void example2() {
		...
		for (int i = 0; i < DIM; i++) {
			...
			EllipsoidNeighborhood<UnsignedByteType> ellipsoid = new EllipsoidNeighborhood<UnsignedByteType>(image);
...
//				val++;
	...
	public static void example1() {
		...
		EllipsoidNeighborhood<UnsignedShortType> ellipsoid = new EllipsoidNeighborhood<UnsignedShortType>(image);
		ellipsoid.setPosition(center);
		ellipsoid.setSpan(span);
