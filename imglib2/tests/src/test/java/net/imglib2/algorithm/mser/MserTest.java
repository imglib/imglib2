...
public class MserTest< T extends IntegerType< T > > implements Component.Handler< MserComponent< T > >, MserProcessor< T >
{
	...
	public MserTest( final ImageStack stack, final int w, final int h, final T delta )
	{
...
//				img = io.openImg( "/home/tobias/workspace/data/wingclip.tif", imgFactory, new IntType() );
		...
		MserTest< IntType > handler = new MserTest< IntType >( stack, w, h, new IntType( 10 ) );
		final MserComponentGenerator< IntType > generator = new MserComponentGenerator< IntType >( new IntType( Integer.MAX_VALUE ) );
		new ComponentTree< IntType, MserComponent< IntType > >( img, generator, handler );
