...
public class ComponentTreeTest< T extends IntegerType< T > > implements ComponentHandler< MserComponent< T > > 
{
	...
	{
		this.handler = new MserComponentHandler< T >( delta );
		this.stack = stack;
		this.w = w;
		this.h = h;
	}
...
//		IJ.run( "Enhance Contrast", "saturated=0.35" );
		...
		ComponentTreeTest< IntType > handler = new ComponentTreeTest< IntType >( stack, w, h, new IntType( 5 ) );
